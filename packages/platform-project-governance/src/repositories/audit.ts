 ...
 * create/archive/trash/restore project, revoke client key). The `details` jsonb
 * is trusted from the caller but the contract is explicit: never include
 * passwords, one-time tokens, client-key secrets or full email addresses.
 */
