...
<style scoped>
.au-global-rail { display: flex; flex-direction: column; align-items: center; min-height: 0; overflow-y: auto; background: var(--color-rail-bg); color: var(--color-rail-fg); }
.au-global-rail__brand { display: grid; width: 48px; height: 48px; min-height: 48px; margin-top: var(--space-2); padding: 0; place-items: center; border: 1px solid rgb(255 255 255 / 24%); border-radius: var(--radius-control); color: var(--color-rail-fg); font-weight: 700; text-decoration: none; }
</style>
