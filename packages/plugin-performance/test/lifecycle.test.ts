...
function createBrowserDouble(options: { readonly subscriptionFails?: boolean } = {}): {
  ...
  readonly listeners: BrowserPerformanceSourceListener[];
  ...
  return {
    ...
    browser: {
      ...
      subscribePerformance: vi.fn((listener: BrowserPerformanceSourceListener) => {
