          ...
          <ul v-if="state.instances.data.length > 0" class="mon-list">
            ...
            >
              ...
              <div class="mon-meta-row">
                ...
                >
                <span v-if="instance.pauseReason !== undefined">{{
                  alertReasonLabel(instance.pauseReason)
                }}</span>
              </div>
              <AppTechnicalDetails summary="实例技术详情">
                instanceId: {{ instance.instanceId }} ruleId: {{ instance.ruleId }}
              </AppTechnicalDetails>
            </li>
          </ul>
