...
const overviewSource = readFileSync('src/views/project/ProjectOverviewView.vue', 'utf8');
const onboardingSource = readFileSync('src/views/project/ProjectOnboardingView.vue', 'utf8');
const dataStatusSource = readFileSync('src/views/project/ProjectDataStatusView.vue', 'utf8');
