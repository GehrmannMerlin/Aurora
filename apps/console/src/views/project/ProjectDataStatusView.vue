...
<style scoped>
.mon-workspace { display: flex; flex-direction: column; gap: var(--space-5); }.mon-authority-line { display: flex; flex-wrap: wrap; gap: var(--space-3); align-items: center; }.mon-note { margin: var(--space-2) 0 0; color: var(--color-text-secondary); }.mon-meta, .mon-stage-meta { color: var(--color-text-secondary); font-size: 12px; }.mon-stage-grid { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: var(--space-3); margin: 0; }.mon-stage-grid > div { padding: var(--space-3); border: 1px solid var(--color-border-default); border-radius: var(--radius-control); }.mon-stage-grid dt, .mon-inline dt { color: var(--color-text-secondary); font-size: 12px; }.mon-stage-grid dd, .mon-inline dd { margin: var(--space-1) 0 0; color: var(--color-text-primary); font-weight: 650; }.mon-stage-grid .mon-stage-meta { display: block; font-weight: 400; }.mon-evidence-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: var(--space-4); }.mon-inline { display: flex; flex-wrap: wrap; gap: var(--space-4); margin: 0; }.mon-actions { display: flex; flex-direction: column; gap: var(--space-2); margin: 0; padding: 0; list-style: none; }.au-button { min-height: var(--control-height); padding: 0 var(--space-3); border: 1px solid var(--color-border-default); border-radius: var(--radius-control); background: var(--color-surface-bg); color: var(--color-text-primary); font: inherit; cursor: pointer; }.au-button:disabled { cursor: default; opacity: .6; } @media (max-width: 900px) { .mon-stage-grid { grid-template-columns: repeat(2, minmax(0, 1fr)); } } @media (max-width: 700px) { .mon-evidence-grid, .mon-stage-grid { grid-template-columns: 1fr; } }
</style>
