...
export async function startPlatformWorker(
  ...
  try {
    const worker = buildPlatformWorkerComposition({
      ...
      aliyunDirectMailAccountName: options.config.aliyunDirectMailAccountName,
      aliyunDirectMailFromAlias: options.config.aliyunDirectMailFromAlias,
      aliyunDirectMailRegionId: options.config.aliyunDirectMailRegionId,
      aliyunDirectMailEndpoint: options.config.aliyunDirectMailEndpoint,
      emailProviderTimeoutMs: options.config.emailProviderTimeoutMs,
      emailOutboxProcessingTimeoutMs: options.config.emailOutboxProcessingTimeoutMs,
      emailOutboxRetryBaseDelayMs: options.config.emailOutboxRetryBaseDelayMs,
      emailOutboxRetryMaxDelayMs: options.config.emailOutboxRetryMaxDelayMs,
