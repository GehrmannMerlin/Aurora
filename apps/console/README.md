...
- 无 G11 剩余—G13 业务：本壳层已实现认证、组织/工作空间（G10）与监控入口页面 C1/C2/C7（PLT-05，`project.onboarding`/`project.overview`/`project.data-status`）；问题/请求/性能工作区（C3—C6，PLT-06）、发布、告警、通知等领域页面仍为占位状态页，不消费未上线的端点。
