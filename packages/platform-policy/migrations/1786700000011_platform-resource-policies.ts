 ...
 * scheme A). Intended to hold at most one row (the platform default), versioned
 * for optimistic concurrency; the "single row" invariant is enforced by the
 * repository layer (Task 2), not by a schema constraint.
 *
