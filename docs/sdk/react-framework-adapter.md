...
批准来源：approved G07 framework-adapter decision 一次性批准（React 版本、公共接口、Error Boundary、StrictMode/重复初始化语义、cleanup、多实例、隐私与排除范围）。无需新 ADR：本增量实现 ADR-003 已批准的四层架构中的框架适配层。
